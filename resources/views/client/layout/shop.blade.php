                                ...
                                <div class="main-menu">
                                    <nav id="mobile-menu">
                                        <ul>
                                            ...
                                            <li class="static">
                                                <a href="/shop">Cửa hàng <i class="icon-arrow-down"></i></a>

                                             </li>
                                            <li class="static">
                                                <a href="about-us.html">Tin ức</a>
                                    ...
                                    <form action="#">
                                        @foreach($categorys as  $c)
                                            <div class="single-widget-category">
                                                ...
                                                <label for="cat-item-1"><a href="/productCategory/{{$c->id}}">{{$c->name}}</a><span>({{ShopController::countProductByIdCate($c->id)}})</span></label>
                                            </div>
                                        @endforeach
                                    ...
                                    <div class="ui-price-slider mb-40">
                                        ...
                                        <div id="slider-range" class="mb-20"></div>
                                            <div class="row">
                                                ...
                                                <div class="col-3">
                                                    <div class="text-end">
                                                        <button type="submit" class="widget-title">Filter</button>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                        ...
                        <div class="shop-top-area mb-40">
                            <div class="row">
                                ...
                                <div class="col-xl-4 col-xl-4 col-md-3 col-sm-3">
                                    <form class="text-sm-end d-flex ps-5" id="form_order" method="get">
                                       <div  class="select-default" >
                                            <select name="orderby" id="short"  class="shorting-select pe-5 me-4 orderby ">
                                                <option value="default" selected>Mặc định</option>
                                                <option value="{{Request::url()}}?orderby=gia:tangdan" >Giá: tăng dần</option>
                                                <option value="{{Request::url()}}?orderby=gia:giamdan">Giá: giảm dần</option>
                                                <option value="{{Request::url()}}?orderby=moinhat">Mới nhất</option>
                                                <option value="{{Request::url()}}?orderby=cunhat">Cũ nhất</option>
                                            </select>

                                       </div>
                                       <!-- <button type="submit" class="p-0 m-0 btn btn-outline-info">Search</button> -->
                                    </form>
                                </div>
                            </div>
                        </div>
