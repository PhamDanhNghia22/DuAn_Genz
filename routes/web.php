...
Route::get('/shop', [ShopController::class, 'ShopProduct']);
...
// Route::get('/productCategory/desc', [ProductCateController::class, 'ProductDESC']);
// Route::get('/productCategory/asc', [ProductCateController::class, 'ProductCate']);
// Route::get('/productCategory/{idsp}', [ProductCateController::class, 'ProductCate']);
